      ...
      <div className="py-20 px-8 h-96 border-2 w-full backdrop-blur-3xl ">
        ...
        <div className="body">
          <p className="text-white flex py-5">
            ...
            Bachelors of Technology in Informational Technology. I have got
            through three years of Diploma in Computer Engineering. I share
          ...
          <button className="bg-white text p-3 border-yellow-500 border-4 flex gap-4 justify-center items-center">
            <FiDownload className="" /> Download CV
          </button>
        </div>
      </div>
    </div>
