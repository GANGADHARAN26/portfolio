                     ...
                     <div className="max-w-sm  border ring-orange-700 rounded-lg shadow backdrop-blur-3xl">
                        ...
                        <div className="p-5">
                          <a href="#" className="flex justify-between">
                            ...
                            <Link
                            to={`/project/${index}`}
                            className="inline-flex items-center px-3 py-1 text-sm font-medium text-center text-white   rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                          >
                            Details
                          </Link>
                          </a>
